    ...
    if(booking.isQrGenerated === false){
        ...
        try {
                ...
                const generateTicketPdf = (doc, qrImageData, qrFilePath, pax, index) => {
                    ...
                    .image(path.join(__dirname, "..", "public", `${booking.service}.jpg`), 200, 50, {width: 200, height: 150,})
                    .fontSize(12)
                    .font('Helvetica')
                    .text(`Guest Name: ${booking.name}`, 50, 280)
                    .fontSize(12)
                    .text(`Guest Email: ${booking.email}`, 50, 310)
                    .fontSize(12)
                    .text(`Mobile Number: ${booking.mobileNumber}`, 50, 340)
                    .fontSize(12)
                    .text(`${pax} Ticket No:  ${index+1}`, 50, 370)
