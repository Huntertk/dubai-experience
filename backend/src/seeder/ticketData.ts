import { TypeTicketData } from "../models/ticketModel";

export const ticketsData:TypeTicketData[] = [
    {
    ...
    {
      title: "Green Planet Dubai Ticket",
      description: [
        "Visit a tropical rainforest right in the middle of Dubai at Green Planet, located in Dubai CityWalk. Meet plants and animals from across 3000 species.",
        "Main attractions: Middle East's 1st glass bio-dome, rare, exotic species, a super large man-made tree (35m tall) with 4 rich layers built around it."
      ],
      service: "green-planet",
      images: [
        "/assets/images/greenPlanetTicketOne.jpg",
        "/assets/images/greenPlanetTicketTwo.jpg",
        "/assets/images/greenPlanetTicketThree.jpg",
        "/assets/images/greenPlanetTicketFour.jpg",
      ],
      preference: [
        {
          title: "General Admission",
  ...
  },
    {
        ...
        description: [
          "AYA Universe transcends the ordinary. It invites you to wander through wonder—a cosmic adventure where art, technology, and imagination collide.",
          "AYA seamlessly blends art installations with cutting-edge technology. From light gardens to observatories, every room is a canvas of creativity."
        ],
        service: "aya-universe",
        images: [
          "/assets/images/ayaUniverseTypeOneImgOne.avif",
          "/assets/images/ayaUniverseTypeOneImgTwo.avif",
          "/assets/images/ayaUniverseTypeOneImgThree.avif",
          "/assets/images/ayaUniverseTypeOneImgFour.avif",
          "/assets/images/ayaUniverseTypeOneImgFive.avif",
          "/assets/images/ayaUniverseTypeOneImgSix.avif",
          "/assets/images/ayaUniverseTypeOneImgSeven.avif"
        ],
        preference: [
          {
            title: "Tickets to AYA Universe",
            details: [
              "Tickets to AYA Universe"
            ],
          }
        ],
        pricing: [
      ...
      },
    {
      ...
      {
        title: "124th + 125th Floor (Non-Prime Hour) Burj Khalifa",
        description: [
        ...
        preference: [
          {
            ...
            details: [
              "124th + 125th Floor (Non-Prime Hour)"
            ],
          }
        ],
        pricing: [
      ...
      {
        title: "Dubai Atlantis Aquaventure + Lost Chamber Aquarium Super Pass",
        description: [
          "Atlantis Water Park, located at Atlantis, The Palm in Dubai, provides guests of all ages with an exhilarating and immersive water park experience. Guests may enjoy the ultimate adrenaline rush with a variety of exhilarating water slides, ranging from heart-pounding drops to twisting curves. The wave pool produces artificial waves, giving guests a beach-like feel.",
        ],
        service: "atlantis-aquaventure",
        ...
        preference: [
          {
            title: "Atlantis Aquaventure And Lost Chamber Aquarium Super Pass",
            details: [
              "Atlantis Aquaventure And Lost Chamber Aquarium Super Pass"
            ],
          }
        ],
        pricing: [
